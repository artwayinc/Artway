...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "air freight art shipping",
    "climate-controlled art transport",
    "antique shipping services",
    "antique packing services",
    "custom antique crating",
    "climate-controlled antique storage",
    "Designer services NYC",
    "Interior designer service",
    "art logistics New Jersey",
    "art logistics Connecticut",
    "art logistics Pennsylvania",
    "art logistics Florida",
    "art logistics Chicago",
    "art logistics Long Island",
    "art logistics Hamptons",
    "art logistics East Coast",
    "antique shipping New York",
    "antique shipping NYC",
  ],
  alternates: {
    canonical: "/services",
  },
